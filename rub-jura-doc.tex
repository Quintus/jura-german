...
@article{ahrens-21-thesen,
  title = "21 Thesen zur Störerhaftung im UWG
    und im Recht des Geistigen Eigentums",
...
Herangehensweise ausgesprochen\footcite[1283]{ahrens-21-thesen}.
...
Der Eintragstyp \verb+@book+ umfasst Monografien und Lehrbücher. Eine
klassisch in einem Verlag veröffentlichte Dissertation erfasst man als
\verb+@book+, im übrigen als \verb+@thesis+.
...
Beispielsurteil\footcite[2129]{lg-koeln-njw-2012-2128}. „[D]ie
allgemeinen Gesetze müssen in ihrer das Grundrecht beschränkenden
Wirkung ihrerseits im Lichte der Bedeutung dieses Grundrechts
gesehen [...] werden.“\footcite[208 war grundlegend]{bverfg-lueth}.
...
Masterarbeiten und ähnliche Dokumente zur Erlangung akademischer Grade
gedacht, die \emph{nicht} klassisch über einen Verlag publiziert
werden. Klassisch über einen Verlag publizierte Werke fallen als
Monografie unter \verb+@book+, sodass für \verb+@thesis+ neben
unveröffentlichten Werken vor allem moderne verlagslose
(Selbst-)\-Pub\-li\-ka\-tio\.nen bleiben. Ist das Dokument online
verfügbar, ist dieser Typ gegenüber \verb+@online+ spezieller und
sollte mit den Feldern \verb+url+ und \verb+urldate+ angereichert
werden. Bei Juristen sind solche Dokumente außerordentlich selten. Das
hier im Beispiel zitierte Werk ist eine Rarität.
...
@thesis{mantz-offenenetze,
  ...
  subtitle = "Rechtliche Gestaltung und Haftung des Access
    Providers in zugangsoffenen (Funk-)Netzen",
  location = "Karlsruhe",
  year = 2008,
...
Die in offenen Netzen erbrachten Dienste fallen trotz
Entgeltlosigkeit unter §\,3 Nr. 24 TKG\footcite[50]{mantz-offenenetze}.
