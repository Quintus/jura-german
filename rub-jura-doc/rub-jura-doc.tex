...
\Biblatex-Dokumentation verwiesen, hier aufgeführt werden nur die
besonderen Eigenarten juristischer Literatur.

\subsection{@artice}

Mit \verb+@article+ werden Publikationen in Fachzeitschriften und laut
\Biblatex-Dokumentation auch Aritkel in Tageszeitungen erfasst (auch
...
ihre Typen der \Biblatex-Dokumentation entnommen werden können, sofern
